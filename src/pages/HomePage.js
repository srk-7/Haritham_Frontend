            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="text-center">
                ...
                >
                  ...
                  <span className="block text-green-200">Employee Marketplace</span>
                </motion.h1>
                <motion.p
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.2 }}
                  className="mt-3 text-base text-green-100 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl"
                >
      ...
      <div className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-base text-green-600 font-semibold tracking-wide uppercase">Our Initiative</h2>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              >
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Homegrown Produce</p>
              ...
              >
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Employee Community</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
              ...
              >
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Sustainable Living</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
              ...
              >
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Easy Marketplace</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
      ...
      <div className="bg-green-50">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            ...
            <span className="block text-green-600">Join our sustainable community today.</span>
          </h2>
